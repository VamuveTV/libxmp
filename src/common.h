...
int8	read8s			(xmp_file);
uint8	read8			(xmp_file);
uint16	read16l			(xmp_file);
uint16	read16b			(xmp_file);
uint32	read24l			(xmp_file);
uint32	read24b			(xmp_file);
uint32	read32l			(xmp_file);
uint32	read32b			(xmp_file);
void	write8			(xmp_file, uint8);
void	write16l		(xmp_file, uint16);
void	write16b		(xmp_file, uint16);
void	write32l		(xmp_file, uint32);
void	write32b		(xmp_file, uint32);
int  	move_data		(xmp_file, xmp_file, int);
