...
static inline uint32 read_bits(xmp_file ibuf, uint32 *bitbuf, int *bitnum, int n)
{
	uint32 retval = 0;
	int i = n;
...
int itsex_decompress8(xmp_file src, uint8 *dst, int len, int it215)
{
	uint32 size = 0;
...
int itsex_decompress16(xmp_file src, int16 *dst, int len, int it215)
{
	uint32 size = 0;
	uint32 block_count = 0;
	uint32 bitbuf = 0;
